...
1) Firstly the bot used to greet the coustomer by asking the users name and there child name then it will greet the user according to the timestamp whether it is good morning.
